    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="add.php">Add Surat</a></li>
            <li><a class="nav-link scrollto" href="view.php">View Surat</a></li>
   ...
   <!-- <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Add Surat</h2>
          <p>Menambahkan berbagai macam elemen surat</p>
        </div>
		  ...
		  <div class="card-body">
			<form class="row g-3" method="post" action="">
			  ...
			  <div class="col-md-6">
			    ...
			    <input type="text" class="form-control" name="ttd_surat" placeholder=" Nama Pembuat Surat">
			  </div>
			  <div class="col-md-6">
			    <label for="ttd_mengetahui" class="form-label">TTD Mengetahui</label>
			    <input type="text" class="form-control" name="ttd_mengetahui" placeholder=" Nama Mengetahui">
			  </div>
			  <div class="col-md-6">
			    <label for="ttd_menyetujui" class="form-label">TTD Menyetujui</label>
			    <input type="text" class="form-control" name="ttd_mengetahui" placeholder=" Nama Menyetujui">
			  </div>
