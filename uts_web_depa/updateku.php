...
$tgl = date('d F Y');
$id = $_GET['id'];
$sql = "SELECT * FROM tbl_anggota join tbl_kontrak_mapel on tbl_anggota.id_anggota=tbl_kontrak_mapel.id_anggota WHERE tbl_anggota.id_anggota='$id' 
...
$query4 = mysqli_query($con, "SELECT * FROM tbl_kontrak_mapel where id_anggota='$id'");
?>
