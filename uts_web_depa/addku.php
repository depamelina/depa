		  ...
		  <form class="row g-3" method="post" action="editku.php" name="form1">
              <div class="col-6">
			     <div class="input-group input-group-outline col-md-6">
                    ...
                    <input type="nama" class="form-control" name="nama" onfocus="focused(this)" onfocusout="defocused(this)">
                  </div>
              </div>
              <div class="col-6">
			     <div class="input-group input-group-outline col-md-6">
                    <label class="form-label">Tempat Lahir</label>
                    <input type="nama" class="form-control" name="tempat_lahir" onfocus="focused(this)" onfocusout="defocused(this)">
                  </div>
              </div>
